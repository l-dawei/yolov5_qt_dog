...
def attempt_download(file, repo='ultralytics/yolov5'):  # from utils.google_utils import *; attempt_download()
    ...
    if not file.exists():
        ...
        try:
            ...
            assets = [x['name'] for x in response['assets']]  # release assets, i.e. ['yolov5s.pth', 'm5.pth', ...]
            tag = response['tag_name']  # i.e. 'v5.0'
        except:  # fallback plan
            assets = ['yolov5s.pth', 'm5.pth', 'yolov5l.pth', 'yolov5x.pth',
                      'yolov5s6.pth', 'yolov5m6.pth', 'yolov5l6.pth', 'yolov5x6.pth']
            try:
