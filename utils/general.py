...
def get_latest_run(search_dir='.'):
    # Return path to most recent 'last.pth' in /runs (i.e. to --resume from)
    last_list = glob.glob(f'{search_dir}/**/last*.pth', recursive=True)
...
def strip_optimizer(f='best.pth', s=''):  # from utils.general import *; strip_optimizer()
